...
# Attempt to import pycaw, but handle failure gracefully
try:
...
class VolumeController:
    ...
    def __init__(self):
        self.is_valid = False
        self.volume = None
        self.min_vol = -65.25  # Default fallback values
        self.max_vol = 0.0     # Default fallback values
    ...
    def set_volume(self, level_percent: float):
        ...
        # Convert percentage to the scalar value required by the API
    ...
    def get_volume(self) -> float:
        ...
        # Convert scalar value from the API back to a percentage
...
# Singleton instance to avoid re-initializing the COM interface
